...
namespace MovieBusinessLayer.BusinessModel.Editables
{
    ...
    public class EditableMovie: BusinessBase<EditableMovie>
    {
        ...
        protected override void AddBusinessRules()
        {
            ...
            BusinessRules.AddRule(new Csla.Rules.CommonRules.MinValue<decimal>(ScoreProperty, 0, "Please give a valid score"));
            BusinessRules.AddRule(new Csla.Rules.CommonRules.MinValue<int>(YearProperty, 1900, "Please give a valid release year"));
